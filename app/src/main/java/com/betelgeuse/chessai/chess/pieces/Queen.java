...
public class Queen extends PieceControl implements Piece.IQueen {
    public Queen(@NonNull Context context, ICoordinate currentCoor, PieceColor pieceColor) {
        ...
        this.setTag(DRAGGABLE_OBJECT +"Q");
    }
